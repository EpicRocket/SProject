...
public:
    ...
    UFUNCTION(BlueprintCallable, BlueprintAuthorityOnly, Category = "페이즈", meta = (DisplayName="Start Phase", AutoCreateRefTerm = "PhaseEnded"))
    ...
    UFUNCTION(BlueprintCallable, BlueprintAuthorityOnly, Category = "페이즈", meta = (DisplayName = "When Phase Starts or Is Active", AutoCreateRefTerm = "WhenPhaseActive"))
    ...
    UFUNCTION(BlueprintCallable, BlueprintAuthorityOnly, Category = "페이즈", meta = (DisplayName = "When Phase Ends", AutoCreateRefTerm = "WhenPhaseEnd"))
    void K2_WhenPhaseEnds(FGameplayTag PhaseTag, EPhaseTagMatchType MatchType, FGPhaseTagDynamicDelegate WhenPhaseEnd);

    UFUNCTION(BlueprintPure, BlueprintAuthorityOnly = false, meta = (AutoCreateRefTerm = "PhaseTag"))
