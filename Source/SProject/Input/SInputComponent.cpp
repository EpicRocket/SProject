...
#include "System/SGameUserSettings.h"
...
void USInputComponent::AddInputMappings(const USInputConfig* InputConfig, UEnhancedInputLocalPlayerSubsystem* InputSubsystem) const
{
	...
	if (const USGameUserSettings* LocalSettings = USGameUserSettings::Get())
	{
...
void USInputComponent::RemoveInputMappings(const USInputConfig* InputConfig, UEnhancedInputLocalPlayerSubsystem* InputSubsystem) const
{
	check(InputConfig);
	check(InputSubsystem);
