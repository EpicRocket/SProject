...
#include "MyGamePhaseAbility.generated.h"
...
class UMyGamePhaseAbility : public UMyGameplayAbility
{
	GENERATED_BODY()

public:

	UMyGamePhaseAbility(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
...
protected:
	...
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "My|Game Phase")
