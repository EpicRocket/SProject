...
#include "MyAbilityTagRelationshipMapping.generated.h"

class UObject;

/** Struct that defines the relationship between different ability tags */
USTRUCT()
struct FMyAbilityTagRelationship
{
	GENERATED_BODY()
...
UCLASS()
class UMyAbilityTagRelationshipMapping : public UDataAsset
{
	GENERATED_BODY()
...
private:
	...
	TArray<FMyAbilityTagRelationship> AbilityTagRelationships;
