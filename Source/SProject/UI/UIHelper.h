...
public:
	...
	static USubActivatableWidget* PushContentToLayer_ForPlayer(APlayerController* PlayerController, UPARAM(meta = (Categories = "UI.Layer")) FGameplayTag LayerName, UPARAM(meta = (AllowAbstract = false)) TSubclassOf<USubActivatableWidget> WidgetClass);

	UFUNCTION(BlueprintCallable)
	static void RemoveContentToLayer_ForPlayer(APlayerController* PlayerController, USubActivatableWidget* RemoveToWidget);
