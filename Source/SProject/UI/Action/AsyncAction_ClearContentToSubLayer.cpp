...
UAsyncAction_ClearContentToSubLayer* UAsyncAction_ClearContentToSubLayer::ClearContentToSubLayer(USubActivatableWidget* ParentWidget, UPARAM(meta = (Categories = "UI.SubLayer")) FGameplayTagContainer InSubLayerNames)
{
